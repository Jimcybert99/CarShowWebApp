...
namespace CarShowJudging.Infrastructure.Migrations
{
    ...
    [Migration("20260603170000_ReplaceSiteNotes")]
    partial class ReplaceSiteNotes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarShowJudging.Core.Models.Score", b =>
                {
                    ...
                    b.Property<int>("Interior").HasColumnType("INTEGER");
                    b.Property<string>("JudgeId").IsRequired().HasColumnType("TEXT");
                    b.Property<int>("PaintAndBody").HasColumnType("INTEGER");
                    b.Property<DateTimeOffset>("ScoredAt").HasColumnType("TEXT");
                    b.Property<int>("ShowAppeal").HasColumnType("INTEGER");
                    b.Property<int>("SuperCoolnessFactor").HasColumnType("INTEGER");
                    b.Property<int>("VehicleId").HasColumnType("INTEGER");
                    b.HasKey("Id");
                    b.HasIndex("JudgeId");
                    b.HasIndex("VehicleId", "JudgeId").IsUnique();
            ...
            modelBuilder.Entity("CarShowJudging.Core.Models.SiteNote", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<string>("AuthorDisplayName").IsRequired().HasColumnType("TEXT");
                    ...
                    b.Property<DateTimeOffset?>("EditedAt").HasColumnType("TEXT");
                    b.Property<bool>("IsImportant").HasColumnType("INTEGER");
                    b.Property<string>("PageContext").HasColumnType("TEXT");
                    b.Property<int?>("ParentNoteId").HasColumnType("INTEGER");
                    b.Property<int?>("VehicleId").HasColumnType("INTEGER");
                    b.HasKey("Id");
            ...
            modelBuilder.Entity("CarShowJudging.Core.Models.Vehicle", b =>
                {
                    b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("INTEGER");
                    b.Property<DateTimeOffset>("CreatedAt").HasColumnType("TEXT");
                    b.Property<int>("EntryNumber").HasColumnType("INTEGER");
                    b.Property<string>("Make").IsRequired().HasColumnType("TEXT");
                    b.Property<string>("Model").IsRequired().HasColumnType("TEXT");
                    b.Property<string>("OwnerId").HasColumnType("TEXT");
                    b.Property<string>("OwnerName").IsRequired().HasColumnType("TEXT");
                    b.Property<string>("PhotoUrl").HasColumnType("TEXT");
                    b.Property<string>("RegisteredById").IsRequired().HasColumnType("TEXT");
            ...
            modelBuilder.Entity("VehicleVehicleClass", b =>
                {
                    b.Property<int>("ClassesId").HasColumnType("INTEGER");
                    b.Property<int>("VehiclesId").HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CarShowJudging.Core.Models.Score", b =>
                {
                    b.HasOne("CarShowJudging.Core.Models.ApplicationUser", "Judge")
                        .WithMany().HasForeignKey("JudgeId")
                        .OnDelete(DeleteBehavior.Restrict).IsRequired();
                    b.HasOne("CarShowJudging.Core.Models.Vehicle", "Vehicle")
                        .WithMany("Scores").HasForeignKey("VehicleId")
            ...
            modelBuilder.Entity("CarShowJudging.Core.Models.Vehicle", b =>
                {
                    ...
                    b.HasOne("CarShowJudging.Core.Models.ApplicationUser", "RegisteredBy")
                        .WithMany().HasForeignKey("RegisteredById")
                        .OnDelete(DeleteBehavior.Restrict).IsRequired();
                    b.Navigation("Owner");
            ...
            modelBuilder.Entity("VehicleVehicleClass", b =>
                {
                    b.HasOne("CarShowJudging.Core.Models.VehicleClass", null)
                        .WithMany().HasForeignKey("ClassesId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                    b.HasOne("CarShowJudging.Core.Models.Vehicle", null)
                        .WithMany().HasForeignKey("VehiclesId").OnDelete(DeleteBehavior.Cascade).IsRequired();
                });
